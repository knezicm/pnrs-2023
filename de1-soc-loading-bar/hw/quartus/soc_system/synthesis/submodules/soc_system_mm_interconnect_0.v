...
module soc_system_mm_interconnect_0 (
	...
	wire   [18:0] leds_0_s1_agent_m0_address;                                                         // leds_0_s1_agent:m0_address -> leds_0_s1_translator:uav_address
	...
	wire   [98:0] leds_0_s1_agent_rf_source_data;                                                     // leds_0_s1_agent:rf_source_data -> leds_0_s1_agent_rsp_fifo:in_data
	...
	wire   [98:0] leds_0_s1_agent_rsp_fifo_out_data;                                                  // leds_0_s1_agent_rsp_fifo:out_data -> leds_0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> leds_0_s1_agent:cp_valid
	wire   [97:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> leds_0_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // leds_0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> leds_0_s1_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> leds_0_s1_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> leds_0_s1_agent:cp_endofpacket
	...
	wire   [97:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [350:0] onchip_memory2_0_s1_agent_rf_source_data;                                           // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [350:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                                        // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [257:0] onchip_memory2_0_s1_agent_rdata_fifo_src_data;                                      // onchip_memory2_0_s1_agent:rdata_fifo_src_data -> onchip_memory2_0_s1_agent_rdata_fifo:in_data
	...
	wire   [97:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire   [97:0] sysid_control_slave_agent_rp_data;                                                  // sysid_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire   [97:0] leds_0_s1_agent_rp_data;                                                            // leds_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire   [97:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [349:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire   [97:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_006:sink_data
	...
	wire   [97:0] cmd_demux_001_src1_data;                                                            // cmd_demux_001:src1_data -> cmd_mux_004:sink0_data
	...
	wire   [97:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> rsp_mux_001:sink1_data
	...
	wire   [97:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                              // onchip_memory2_0_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> onchip_memory2_0_s1_cmd_width_adapter:in_channel
	...
	wire  [349:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;                                     // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire    [4:0] onchip_memory2_0_s1_cmd_width_adapter_src_channel;                                  // onchip_memory2_0_s1_cmd_width_adapter:out_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [349:0] router_005_src_data;                                                                // router_005:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                               // onchip_memory2_0_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [4:0] router_005_src_channel;                                                             // router_005:src_channel -> onchip_memory2_0_s1_rsp_width_adapter:in_channel
	...
	wire   [97:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;                                     // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	...
	wire    [4:0] onchip_memory2_0_s1_rsp_width_adapter_src_channel;                                  // onchip_memory2_0_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire   [97:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_003:sink1_data
	...
	wire   [97:0] rsp_demux_003_src0_data;                                                            // rsp_demux_003:src0_data -> crosser_002:in_data
	...
	wire   [97:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink3_data
	...
	wire   [97:0] rsp_demux_003_src1_data;                                                            // rsp_demux_003:src1_data -> crosser_003:in_data
	...
	wire          leds_0_s1_agent_rdata_fifo_src_valid;                                               // leds_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] leds_0_s1_agent_rdata_fifo_src_data;                                                // leds_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          leds_0_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_001:in_0_ready -> leds_0_s1_agent:rdata_fifo_src_ready
	...
	wire  [257:0] onchip_memory2_0_s1_agent_rdata_fifo_out_data;                                      // onchip_memory2_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	...
	wire  [257:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> onchip_memory2_0_s1_agent:rdata_fifo_sink_data
