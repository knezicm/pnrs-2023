...
module soc_system_mm_interconnect_1 (
		...
		input  wire        buttons_0_reset_reset_bridge_in_reset_reset, // buttons_0_reset_reset_bridge_in_reset.reset
	...
	wire          buttons_0_s1_agent_rp_valid;                              // buttons_0_s1_agent:rp_valid -> router_002:sink_valid
	wire  [115:0] buttons_0_s1_agent_rp_data;                               // buttons_0_s1_agent:rp_data -> router_002:sink_data
	wire          buttons_0_s1_agent_rp_ready;                              // router_002:sink_ready -> buttons_0_s1_agent:rp_ready
	wire          buttons_0_s1_agent_rp_startofpacket;                      // buttons_0_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          buttons_0_s1_agent_rp_endofpacket;                        // buttons_0_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [115:0] hex_3_s1_agent_rp_data;                                   // hex_3_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [115:0] hex_4_s1_agent_rp_data;                                   // hex_4_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [115:0] hex_5_s1_agent_rp_data;                                   // hex_5_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [115:0] hex_1_s1_agent_rp_data;                                   // hex_1_s1_agent:rp_data -> router_008:sink_data
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> buttons_0_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> buttons_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // buttons_0_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [6:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> buttons_0_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> buttons_0_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> buttons_0_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                    // cmd_mux_003:src_valid -> hex_3_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                     // cmd_mux_003:src_data -> hex_3_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                    // hex_3_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                  // cmd_mux_003:src_channel -> hex_3_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                            // cmd_mux_003:src_startofpacket -> hex_3_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                              // cmd_mux_003:src_endofpacket -> hex_3_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                    // cmd_mux_004:src_valid -> hex_4_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                     // cmd_mux_004:src_data -> hex_4_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                    // hex_4_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                  // cmd_mux_004:src_channel -> hex_4_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                            // cmd_mux_004:src_startofpacket -> hex_4_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                              // cmd_mux_004:src_endofpacket -> hex_4_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_005_src_valid;                                    // cmd_mux_005:src_valid -> hex_5_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_005_src_data;                                     // cmd_mux_005:src_data -> hex_5_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                    // hex_5_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                  // cmd_mux_005:src_channel -> hex_5_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                            // cmd_mux_005:src_startofpacket -> hex_5_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                              // cmd_mux_005:src_endofpacket -> hex_5_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_006_src_valid;                                    // cmd_mux_006:src_valid -> hex_1_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_006_src_data;                                     // cmd_mux_006:src_data -> hex_1_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                    // hex_1_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                  // cmd_mux_006:src_channel -> hex_1_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                            // cmd_mux_006:src_startofpacket -> hex_1_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                              // cmd_mux_006:src_endofpacket -> hex_1_s1_burst_adapter:sink0_endofpacket
	...
	wire          buttons_0_s1_agent_rdata_fifo_out_valid;                  // buttons_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] buttons_0_s1_agent_rdata_fifo_out_data;                   // buttons_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          buttons_0_s1_agent_rdata_fifo_out_ready;                  // avalon_st_adapter:in_0_ready -> buttons_0_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> buttons_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> buttons_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // buttons_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> buttons_0_s1_agent:rdata_fifo_sink_error
	...
	wire          hex_3_s1_agent_rdata_fifo_out_valid;                      // hex_3_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] hex_3_s1_agent_rdata_fifo_out_data;                       // hex_3_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          hex_3_s1_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_003:in_0_ready -> hex_3_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                        // avalon_st_adapter_003:out_0_valid -> hex_3_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                         // avalon_st_adapter_003:out_0_data -> hex_3_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                        // hex_3_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                        // avalon_st_adapter_003:out_0_error -> hex_3_s1_agent:rdata_fifo_sink_error
	wire          hex_4_s1_agent_rdata_fifo_out_valid;                      // hex_4_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] hex_4_s1_agent_rdata_fifo_out_data;                       // hex_4_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          hex_4_s1_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_004:in_0_ready -> hex_4_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                        // avalon_st_adapter_004:out_0_valid -> hex_4_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                         // avalon_st_adapter_004:out_0_data -> hex_4_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                        // hex_4_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                        // avalon_st_adapter_004:out_0_error -> hex_4_s1_agent:rdata_fifo_sink_error
	wire          hex_5_s1_agent_rdata_fifo_out_valid;                      // hex_5_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] hex_5_s1_agent_rdata_fifo_out_data;                       // hex_5_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          hex_5_s1_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_005:in_0_ready -> hex_5_s1_agent_rdata_fifo:out_ready
	...
	wire          hex_1_s1_agent_rdata_fifo_out_valid;                      // hex_1_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] hex_1_s1_agent_rdata_fifo_out_data;                       // hex_1_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          hex_1_s1_agent_rdata_fifo_out_ready;                      // avalon_st_adapter_006:in_0_ready -> hex_1_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (buttons_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~buttons_0_reset_reset_bridge_in_reset_reset),             //        clk_reset.reset_n
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pll_0_outclk0_clk),                                //             clk.clk
		.reset                   (buttons_0_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (buttons_0_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (buttons_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
