...
/*
 * Macros for device 'mailbox_4', class 'altera_avalon_mailbox_simple'
 * The macros are prefixed with 'MAILBOX_4_'.
 * The prefix is the slave descriptor.
 */
#define MAILBOX_4_COMPONENT_TYPE altera_avalon_mailbox_simple
#define MAILBOX_4_COMPONENT_NAME mailbox_4
#define MAILBOX_4_BASE 0x10
#define MAILBOX_4_SPAN 16
#define MAILBOX_4_END 0x1f
